...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.delete_column('xelpaste_snippet', 'expire_type')

        # Deleting field 'Snippet.view_count'
        db.delete_column('xelpaste_snippet', 'view_count')
